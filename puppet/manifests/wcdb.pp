...
class wcdb_11g {
  require wcdb_os
   ...
   oradb::dbactions{ 'start wcDb': 
                   oracleHome              => hiera('oracle_home_dir'),
                   user                    => hiera('oracle_os_user'),
                   group                   => hiera('oracle_os_group'),
                   action                  => 'start',
                   dbName                  => hiera('oracle_database_name'),
                   require                 => Oradb::Database['wcDb'],
   }
   ...
   oradb::autostartdatabase{ 'autostart oracle': 
                   ...
                   user                    => hiera('oracle_os_user'),
                   dbName                  => hiera('oracle_database_name'),
                   require                 => Oradb::Dbactions['start wcDb'],
   }

  oradb::rcu{ 'DEV':
                   rcuFile                => 'ofm_rcu_linux_11.1.1.8.0_64_disk1_1of1.zip',
                   version                => '11.1.1.8',
                   product                => 'webcenter',
                   oracleHome             => hiera('oracle_home_dir'),
                   user                   => hiera('oracle_os_user'),
                   ...
                   downloadDir            => hiera('oracle_download_dir'),
                   action                 => 'create',
                   dbServer               => 'wcdb.example.com:1521',  
